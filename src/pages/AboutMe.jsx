...
import adrian from "../assets/image/me_portfolio.jpeg";
import { Services } from "../data/servicesData";
import { useState } from "react";
import { FAQ } from "../data/FAQData";

import icon_figma from "../assets/icon/figma.svg";
import icon_photoshop from "../assets/icon/photoshop.svg";
import icon_ai from "../assets/icon/ai.svg";
import icon_xd from "../assets/icon/xd.svg";
import icon_invision from "../assets/icon/invision.svg";
        ...
        <div className="row g-0 mx-3 mx-sm-4 mx-md-5 py-5">
          <div className="col-8">
            <p className="aa-fs-p-4">
              Hi, I’m Adrian Albuera, a Design Specialist with over 3 years of
          ...
          <div className="d-flex gap-2">
            <img src={icon_figma}  height={"50"} width={"50"} />
            <img src={icon_xd} height={"50"} width={"50"} />
            <img src={icon_photoshop}  height={"50"} width={"50"} />
            <img src={icon_ai}  height={"50"} width={"50"} />
            <img src={icon_invision}  height={"50"} width={"50"} />
            <img src={icon_canva}  height={"50"} width={"50"} />
            <img src={icon_capcut}  height={"50"} width={"50"} />
